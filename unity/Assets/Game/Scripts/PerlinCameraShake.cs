    ...
    private IEnumerator ShakeJob()
    {
        ...
        while (!Mathf.Approximately(_trauma, 0))
        {
            ...
            if (shouldTranslate)
            {
                ...
                transform.localPosition = translationOffset + _originalCamPosition;
            ...
            if (shouldRotate)
            {
                ...
                transform.localRotation = Quaternion.Euler(rotationOffset) * _originalCamRotation;
        ...
        while (!ApproximatelyEqual(transform.localPosition, _originalCamPosition))
        {
